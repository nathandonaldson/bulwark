"""CLI entry point: `python -m bulwark.tools.bench` (v2.0.0, ADR-034).

Also reachable as `python -m bulwark_bench` via the back-compat shim
in `src/bulwark_bench/__init__.py` (ADR-050).
"""
...
from bulwark.tools.bench import __version__
...
from bulwark.tools.bench.runner import BenchRunner, stderr_progress
